...
export function getExamIssueSummary(record) {
...
export function buildModalDetailHtml(record) {
...
export function renderExamRequests(container, records, modalController) {
  if (!records.length) {
